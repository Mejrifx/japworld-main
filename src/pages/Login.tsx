      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="border-shoji bg-card/60 backdrop-blur-sm p-8 relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-primary/50 font-display text-xs tracking-widest mb-1">クライアントポータル</p>
            <h1 className="font-display text-2xl text-foreground">Client Portal</h1>
            <p className="text-muted-foreground text-sm mt-2">
              Sign in to access your account, vehicles, and documents.
            </p>
          </div>
